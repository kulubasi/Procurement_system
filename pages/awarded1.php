        ...
        <!-- /.modal-dialog -->
            ...
            if($run == true){
                ...
                while($row=mysqli_fetch_array($run)){
                    ...
                    $g =$row[7];
                    if ($g==1) {
                      echo '<form role="form" method="post" action="award.php">
                                 <div class="row">
                                <div class="col-sm-2">
                                </div>
                                  <div class="col-sm-2">
                                  ...
                                  <div class="col-sm-2">
                                    <button type="submit" class="btn btn-primary" name="set6">setdates</button>
                                  </div>
                                  <div class="col-sm-2">
                                 </div>
                                 <div class="col-sm-4">
                    ...
                    elseif ($g==2) {
                     echo '<form role="form" method="post" action="award.php">
                                ...
                                <div class="col-sm-2">
                                  ...
                                  <div class="col-sm-2">
                                    <input type="date" name="tender" class="form-control" >
                                  </div>
                                  <div class="col-sm-2">
                                 </div>
                                 <div class="col-sm-4">
