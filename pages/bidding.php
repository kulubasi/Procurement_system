  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../dist/img/FaceApp_164357366584_1.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="bidding.php" class="nav-link active">
              <p>Bidding
                  </p></a>
          </li>
          <li class="nav-item">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a>>bidding</li>
            </ol>
            ...
            if($run == true){
              $n =0;
                while($row=mysqli_fetch_array($run)){
                    ...
                    echo'<td>' .$f.'</td>';
                    echo'<td>' .$g.'</td>';
                    echo  '<td align="center" > <a  href="pro.php?pro='.$b.'"  class="btn btn-primary btn-xs  "> View</a></td>';
                  echo '</tr>';
